    ...
    <div class="signin-form col-lg-6">
        ...
        <div class="row">
            <div class="col-lg-4 btn-facebook">
                <a href="#" class="btn btn-primary btn-lg w-100"><i class="bi bi-facebook"></i> Facebook</a>
            </div>
            <div class="col-lg-4 btn-google">
                <a href="#" class="btn btn-danger btn-lg w-100"><i class="bi bi-google"></i> Google</a>
            </div>
            <div class="col-lg-4 btn-twitter">
                <a href="#" class="btn btn-info btn-lg w-100"><i class="bi bi-twitter"></i> Twitter</a>
            </div>
        </div>
    </div>
@endsection
